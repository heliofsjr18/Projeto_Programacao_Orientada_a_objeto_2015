...
public class TelaProduto extends javax.swing.JFrame {
    ...
    private void atualizarGrid(){
        ...
        try {
            for(Produto prod : f.listarProduto()){
                modelo.addRow(new Object[] {prod.getProd_codigo(), prod.getForn_codigo().getForn_codigo(), prod.getProd_descricao(),prod.getProd_qtdEstoque(), prod.getProd_valor()});
            }
    ...
    private void initComponents() {
        ...
        Table_Funcionario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo do Produto", "Codigo do Fornecedor", "Descrição", "Qtd Estoque", "Valor"
            }
        ) {
