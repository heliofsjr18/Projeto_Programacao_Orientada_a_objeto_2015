...
public class TelaCliente extends javax.swing.JFrame {
    ...
    private void atualizarGrid(){
        ...
        try {
            for(Cliente cli : f.listarCliente()){
                modelo.addRow(new Object[] {cli.getCli_codigo(), cli.getCli_cpf(), cli.getCli_nome(), cli.getCli_telefone(),cli.getCli_endereco()} );
            }
    ...
    private void initComponents() {
        ...
        Table_Funcionario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "CPF", "Nome", "Telefone", "Endereço"
            }
        ) {
