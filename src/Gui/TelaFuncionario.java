...
public class TelaFuncionario extends javax.swing.JFrame {
    ...
    private void atualizarGrid(){
        ...
        try {
            for(Funcionario fun : f.listarFuncionario()){
                modelo.addRow(new Object[] {fun.getFun_codigo(), fun.getFun_cpf(), fun.getFun_nome(), fun.getFun_telefone(),fun.getFun_login(), fun.getFun_senha()} );
            }
    ...
    private void initComponents() {
        ...
        Table_Funcionario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "CPF", "Nome", "Telefone", "Login", "Senha"
            }
        ) {
